...
const String txSignIn = "Sign in";
const String txCreateAccount = "Create Account";
const String txEmailAddress = "Email address";
const String txEmail = "Email";
const String txUsername = "Username";
...
const String txSuccess = "Success";
const String txFailed = "Failed";
const String txLogin = "Login";
const String txSignup = "Signup";
const String txErrorInAuth = "Error while ";
...
const String txPasswordMustBeSame = "Password must be same";
const String txFieldCanNotBeEmptyValidation = "Field Can Not Be Empty";
const String txEnterValidEmailValidation = "Enter a valid email";
const String txEnterValidPassValidation = "Enter a valid password";
